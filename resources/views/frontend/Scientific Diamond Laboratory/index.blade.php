            ...
            @if($sliders)
                @foreach($sliders as $slider)
                    ...
                    <div class="carousel-item carousel-item-home @if ($counter==1)  {{"active"}}@endif "
                         style="background-image: url('{{'sliders/Scientific Diamond Lab/'.$slider->image}}'); background-position-y: 80px; ">
                        <div class="row">
                            <div class="container">
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="card" style="width: 18rem;">
                                <img class="card-img-top"
                                     src="{{asset('services/Scientific Diamond Lab/'.$service->image)}}"
                                     alt="">
                                <div class="card-body">
                                    <h5 class="card-title">
                                        @if(App::isLocale('en'))
                    ...
                    @foreach($products as $product)
                        <div class="col-lg-4 col-md-12">
                            <a href="{{url('sdclab/products/'.$product->slug)}}">
                                <div class="card" style="width: 18rem;">
                                    <img class="card-img-top"
                                         src="{{asset('products/Scientific Diamond Lab/'.$product->image)}}"
                                         alt="">
                                    <div class="card-body">
                                        <h5 class="card-title">
                            ...
                            @foreach($customers as $customer)
                                <div>
                                    <a href="@if($customer->link !=NULL){{$customer->link}}@else # @endif"><img
                                                src="{{asset('customers/Scientific Diamond Lab/'.$customer->image)}}"
                                                alt=""></a>
                                </div>
                            @endforeach
                        @endif
