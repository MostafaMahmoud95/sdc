    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link  {{(\App\Http\Controllers\Frontend\ScientificDiamondCompany\HomePageController::CurrentPage("sdc/contact"))? 'active-page': ''}} " href="{{url('sdc/contact')}}">{{trans('sdc.contact')}}</a>

                    </li>
                    <li class="nav-item">
                          <a class="nav-link  {{(\App\Http\Controllers\Frontend\ScientificDiamondCompany\HomePageController::CurrentPage("sdc/partners"))? 'active-page': ''}} " href="{{url('sdc/partners')}}">{{trans('sdc.partners')}}</a>

                    </li>
                    <li class="nav-item">
                         <a class="nav-link  {{(\App\Http\Controllers\Frontend\ScientificDiamondCompany\HomePageController::CurrentPage("sdc/customers"))? 'active-page': ''}} " href="{{url('sdc/customers')}}">{{trans('sdc.customers')}}</a>

                    </li>
                    <li class="nav-item">
                      <a class="nav-link  {{(\App\Http\Controllers\Frontend\ScientificDiamondCompany\HomePageController::CurrentPage("sdc/jobs"))? 'active-page': ''}} " href="{{url('sdc/jobs')}}">{{trans('sdc.jobs')}}</a>

                    </li>
                    <li class="nav-item">
                        <a class="nav-link  {{(\App\Http\Controllers\Frontend\ScientificDiamondCompany\HomePageController::CurrentPage("sdc/news"))? 'active-page': ''}} " href="{{url('sdc/news')}}">{{trans('sdc.news')}}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  {{(\App\Http\Controllers\Frontend\ScientificDiamondCompany\HomePageController::CurrentPage("sdc/products"))? 'active-page': ''}} " href="{{url('sdc/products')}}">{{trans('sdc.products')}}</a>

                    </li>
                    <li class="nav-item">
                       <a class="nav-link  {{(\App\Http\Controllers\Frontend\ScientificDiamondCompany\HomePageController::CurrentPage("sdc/services"))? 'active-page': ''}} " href="{{url('sdc/services')}}">{{trans('sdc.services')}}</a>

                    </li>
                    <li class="nav-item">
                       <a class="nav-link  {{(\App\Http\Controllers\Frontend\ScientificDiamondCompany\HomePageController::CurrentPage("sdc/about"))? 'active-page': ''}} " href="{{url('sdc/about')}}">{{trans('sdc.about')}}</a>

              
                    </li>
                    <li class="nav-item" >
                        <a class="nav-link  {{(\App\Http\Controllers\Frontend\ScientificDiamondCompany\HomePageController::CurrentPage("sdc"))? 'active-page': ''}} " href="{{url('sdc')}}">{{trans('sdc.home')}}</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="col-lg-3 col-md-12 footer-align">
                <div class="container">
                    <div class="main-footer-news2">
                        ...
                        @php
                            $three_news = \App\News::OrderBy('id', 'desc')->Where('department_id', 1)->take(3)->get();
                        ...
                        @foreach($three_news as $one_news)
                            <div class="news-paragraph">
                                ...
                                <p>
                                    @if(App::isLocale('ar'))
                                        <a href="{{url('sdc/news/'.$one_news->slug)}}">   {{str_limit($one_news->intro_ar,100)}} </a>
                                    @else
                                        <a href="{{url('sdc/news/'.$one_news->slug)}}">{{str_limit($one_news->intro_en,100)}}</a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    <ul class="footer-nav">
                        <li><a href="{{url('sdc')}}">{{trans('sdc.home')}}</a></li>
                        <li><a href="{{url('sdc/about')}}">{{trans('sdc.about')}}</a></li>
                        <li><a href="{{url('sdc/services')}}">{{trans('sdc.our services')}}</a></li>
                        <li><a href="{{url('sdc/products')}}">{{trans('sdc.our products')}}</a></li>
                        <li><a href="{{url('sdc/news')}}">{{trans('sdc.news')}}</a></li>
                        <li><a href="{{url('sdc/jobs')}}">{{trans('sdc.jobs')}}</a></li>
                        <li><a href="{{url('sdc/customers')}}">{{trans('sdc.customers')}}</a></li>
                        <li><a href="{{url('sdc/partners')}}">{{trans('sdc.partners')}}</a></li>
                        <li><a href="{{url('sdc/contact')}}"> {{trans('sdc.contact')}}</a></li>
                    </ul>
                </div>
                <div class="col-lg-6 col-md-12">
