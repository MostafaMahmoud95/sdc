        ...
        <div class="col-sm-12">
            <div class="card-box">
                ...
                <p class="text-muted font-13">
                    ...
                    <a href="{{route('sliders.create')}}" class="btn btn-success" role="button">Add
                        Slider</a><br><br>
                ...
                <table data-toggle="table"
                    ...
                    <tr>
                        ...
                        <th data-field="department" data-align="center" data-sortable="true">Department Name </th>
                        ...
                        <tr>
                            ...
                            <td  style="text-align: center;"><a href="{{route('sliders.show',$slider->id)}}" class="btn btn-info" role="button">View</a>
                                ...
                                <button type="button" class="btn btn-danger" data-toggle="modal"
                                        data-target="#deletesliders_{{$slider->id}}">Delete
                                </button>
                                <div class="modal" tabindex="-1" role="dialog" id="deletesliders_{{$slider->id}}">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">

                                            <div class="modal-header">
                                                <h5 class="modal-title" style="color: black"><b> Do you want to delete this slider ? </b></h5>
