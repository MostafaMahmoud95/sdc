                ...
                <div class="card-box product-detail-box">
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <div class="sp-wrap">
                                <a href="{{URL::to('public/jobs/'.$job->image)}}"><img
                                            src="{{URL::to('public/jobs/'.$job->image)}}"
                        ...
                        <div class="col-12">
                            ...
                            <div class="table-responsive m-t-20">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td>Arabic Location</td>
                                        <td>
                                            {{$job->location_ar}}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>English Location</td>
                                        <td>
                                            {{$job->location_en}}
                                        </td>
                                    </tr>
