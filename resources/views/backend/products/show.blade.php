                ...
                <div class="card-box product-detail-box">
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <div class="sp-wrap">
                                <a href="{{URL::to('public/products/'.$product->department->title_en.'/'.$product->image)}}"><img
                                            src="{{URL::to('public/products/'.$product->department->title_en.'/'.$product->image)}}"
